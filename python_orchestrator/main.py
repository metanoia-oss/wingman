"""Main entry point for the Python orchestrator."""
...
from python_orchestrator.policy import PolicyEvaluator
from python_orchestrator.transports import (
    Platform,
    MessageEvent,
    BaseTransport,
    WhatsAppTransport,
...
class MultiTransportAgent:
    ...
    async def start(self) -> None:
        ...
        whatsapp = WhatsAppTransport(self.settings.node_dir)
